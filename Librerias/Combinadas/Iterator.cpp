...
int main ()
{
    ...
    it++; //Movemos el iterador una posici�n (ahora estamos en 20)

    //Se inserta un 11 en la posici�n del 10 11 20 30 40 50
    miLista.insert (it,11);

    //miLista.insert (it,3,18);
    //En la actual posici�n del 20 insertamos un 18 tres veces
    ...
    {
        cout<< ' ' << *it; //Se muestra el valor al cual est� a�ntando el iterador
    }
